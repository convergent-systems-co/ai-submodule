...
class TestGateAction:
    ...
    def test_yellow_phase7_skip_dispatch(self):
    ...
    def test_orange_deployment_phases_checkpoint(self, phase):
        assert gate_action(phase, Tier.ORANGE) == Action.CHECKPOINT
