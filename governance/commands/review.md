...
7. Save output to `.artifacts/panels/<panel>.md`.
8. Save structured emission JSON to `.artifacts/emissions/<panel>.json`.
...
1. Scan `.artifacts/emissions/*.json` for structured emissions.
...
2. Confirm the output file locations (`.artifacts/panels/<panel>.md` and `.artifacts/emissions/<panel>.json`).
