...
Maximum fix attempts: **3**. If tests still fail after 3 attempts, escalate to the Tech Lead with the failure details. Do not push.
...
2. The Tech Lead decides whether to:
