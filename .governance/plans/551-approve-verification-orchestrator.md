...
Move the APPROVE structural integrity checks from the Code Manager persona (prompt-based) into deterministic Python code in the orchestrator, making the most critical governance decision code-based rather than prompt-based.
