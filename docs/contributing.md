# Contributing to the Dark Forge

Welcome! We're glad you're interested in contributing to the Dark Forge. This guide will help you understand the project structure, development workflow, and contribution standards.

## What This Project Is

The Dark Forge is an **AI governance framework** for autonomous software delivery. It's distributed as a git submodule to consuming repositories and contains:
...
```bash
git clone --recurse-submodules git@github.com:YOUR_USERNAME/dark-forge.git
cd dark-forge
```
...
```bash
git remote add upstream git@github.com:convergent-systems-co/dark-forge.git
```
...
```bash
cp governance/templates/prompts/plan-template.md .artifacts/plans/348-contributing-page.md
```
...
- [ ] Plan exists in `.artifacts/plans/`
- [ ] Tests pass locally
...
Your PR will trigger the Dark Forge workflow (`.github/workflows/dark-factory-governance.yml`):
...
| `.artifacts/plans/` | Implementation plans | Append-only (archived on merge) |
...
.ai/  (or repo root when working on this repo directly)
  ...
  governance/
    personas/agentic/          7 agentic personas (Project Manager, DevOps Engineer, Tech Lead, Coder, IaC Engineer, Test Evaluator, Document Writer)
    prompts/
...
1. **Project Manager** — Portfolio orchestration, multiplexed Tech Leads (opt-in)
2. **DevOps Engineer** — Pre-flight checks, issue triage, routing
3. **Tech Lead** — Intent validation, panel selection, review coordination
...
- **Documentation:** [Dark Forge Docs](https://set-apps.github.io/dark-forge)
- **Issues:** [Dark Forge Issues](https://github.com/convergent-systems-co/dark-forge/issues)
- **Pull Requests:** [Dark Forge PRs](https://github.com/convergent-systems-co/dark-forge/pulls)
...
Your contributions make this project better. Thank you for taking the time to contribute to the Dark Forge.
