...
Six panels are mandatory on every PR regardless of files changed: code-review, security-review, threat-modeling, cost-analysis, documentation-review, and data-governance-review. Four of the five policy profiles enforce this full set; the fast-track profile requires only code-review and security-review. See `governance/policy/` for all 5 policy profiles and 4 supporting policy configurations (plus 14 future Phase 5 configurations in `governance/policy/future/`).
