# ISO/IEC 42001 -- Dark Forge Mapping
...
ISO/IEC 42001 follows the Annex SL high-level structure (clauses 4-10) common to all ISO management system standards. This document maps each clause to the Dark Forge's artifacts, processes, and controls, demonstrating how the platform supports organizations seeking ISO/IEC 42001 certification.
...
| 6. Planning | `.artifacts/plans/` | Mandatory plan-first workflow, risk treatment plans |
...
| 6.2 AI objectives | `GOALS.md` tracks project objectives; plans document implementation intent | `GOALS.md`, `.artifacts/plans/` |
| 6.3 Planning of changes | Mandatory plan-first workflow -- every implementation requires a plan before code | `.artifacts/plans/`, plan template |
...
| 9.3 Management review | Retrospective phase in agentic startup sequence; checkpoint system preserves state across sessions | Phase 5 retrospective, `.artifacts/checkpoints/` |
...
For organizations using Dark Forge to support ISO/IEC 42001 certification:
