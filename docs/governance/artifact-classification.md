...
| `.artifacts/plans/` | Implementation plans | Load only the active plan for the current task |
...
| `.artifacts/plans/` | Implementation plans (Markdown) | Retained with the branch/PR lifecycle |
