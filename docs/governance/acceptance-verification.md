...
The Tech Lead invokes this workflow after Phase 3 (Implementation) and before Phase 4 (Evaluation & Review) in `startup.md`, when a formal spec exists for the change. For changes without formal specs, the standard panel review flow applies directly.
