...
**Template location:** `governance/templates/prompts/runtime-di-template.md`
...
| `governance/templates/prompts/runtime-di-template.md` | Implemented (PR #89) | DI template for runtime-generated intents |
