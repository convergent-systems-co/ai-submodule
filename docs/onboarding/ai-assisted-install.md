...
Install Dark Forge in your consuming repo by telling your AI tool to read the source repository and set it up. No manual steps required.
...
```
Read https://github.com/convergent-systems-co/dark-forge (Dark Forge) and install it as a
...
1. Add the submodule: `git submodule add git@github.com:convergent-systems-co/dark-forge.git .ai`
...
```
Add git@github.com:convergent-systems-co/dark-forge.git as a submodule at .ai,
...
```
I want to add the Dark Forge governance framework to this repo.
Add git@github.com:convergent-systems-co/dark-forge.git as a git submodule at .ai,
...
This begins the 5-phase agentic loop: DevOps Engineer pre-flight → Tech Lead planning → parallel Coder dispatch → Test Evaluator evaluation → merge.
...
| Issue | Solution |
|-------|---------|
| **Permission denied on submodule** | Ensure you have SSH access to the Dark Forge repo (`convergent-systems-co/dark-forge`). Test: `ssh -T git@github.com` |
