...
| `governance/personas/agentic/` | Autonomous agent personas | Tech Lead, Coder |
...
| `governance/personas/agentic/tech-lead.md` | Cognitive | Orchestration persona |
| `governance/personas/agentic/coder.md` | Cognitive | Execution persona |
| `governance/templates/prompts/plan-template.md` | Cognitive | Standardized plan template |
...
5. **Configure branch protection** — Add Dark Forge status checks as required
...
6. **Add checkpoint system** — Implement `.artifacts/checkpoints/` for context reset recovery
...
The repository is currently `convergent-systems-co/dark-forge`. Given its evolution into the Dark Forge platform, renaming is recommended. Top candidates:
...
| + | Plan template | `governance/templates/prompts/plan-template.md` | Complete |
| + | Tech Lead persona | `governance/personas/agentic/tech-lead.md` | Complete |
