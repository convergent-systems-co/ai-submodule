...
| 2 — Planning | Intent validation, panel selection, plan creation | 10K-20K per issue | Code Manager persona; one plan per issue |
| 3 — Implementation | Code generation, tests, documentation | 50K-100K per Coder | Coder persona in isolated worktree; largest phase |
| 4 — Review | Panel emissions, CI monitoring, Tester evaluation | 20K-50K | 6 required panels + security re-review |
