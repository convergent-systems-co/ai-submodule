# Dark Forge: Autonomy Metrics and Index
...
This document defines the metrics framework and composite Autonomy Index used to measure, track, and govern the progression of the Dark Forge system toward full autonomous operation. Each metric is designed to be computed deterministically from structured data already produced by the system -- panel emissions, policy engine decisions, version manifests, and CI logs.
...
The Autonomy Index (AI-X) is a single composite score from 0 to 100 that represents the overall autonomous capability and trustworthiness of the Dark Forge governance system.
...
| 75 -- 100 | Phase 5 | Full Autonomy (Dark Forge) | Auto-merge enabled for all risk levels including critical, with policy-defined exceptions. Monthly metric review. Anomaly-based alerting replaces scheduled review. |
...
```
# Dark Forge -- Weekly Autonomy Report
