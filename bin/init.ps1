...
if ($IsSubmodule) {
    ...
    # Project directories
    $projectDirs = @('.artifacts/plans', '.artifacts/panels', '.artifacts/checkpoints', '.artifacts/state')
    ...
    # Migrate old directory paths to new .artifacts/ structure
    $migrations = @{
        '.plans' = '.artifacts/plans'
        '.panels' = '.artifacts/panels'
        'governance/checkpoints' = '.artifacts/checkpoints'
        '.governance-state' = '.artifacts/state'
    }
