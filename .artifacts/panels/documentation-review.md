...
- **Advisory (medium severity):** The project would benefit from a documentation site deployed via GitHub Pages at `https://SET-Apps.github.io/dark-forge`. This is not a blocking finding.
