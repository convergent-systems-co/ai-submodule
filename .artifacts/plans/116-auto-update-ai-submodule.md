...
**Date:** 2026-02-23
**Status:** completed
**Issue:** https://github.com/convergent-systems-co/dark-forge/issues/116
**Branch:** NETWORK_ID/fix/116/auto-update-dark-forge
...
1. Add a new pre-flight step to `startup.md` (before the existing repo config checks):
   ...
   - If not in a submodule context (running in Dark Forge itself), skip
