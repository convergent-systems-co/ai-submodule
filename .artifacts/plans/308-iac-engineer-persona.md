...
Create a new agentic persona — IaC Engineer — that the Team Lead can delegate to when infrastructure-as-code work is required. The persona follows JM Paved Roads Bicep standards derived from the JM-Paved-Roads GitHub org, with Terraform support.
...
|------|-------------------|
| `governance/personas/agentic/team-lead.md` | Add IaC routing decision and ASSIGN transitions |
...
2. Update Team Lead to detect and route IaC work
