...
The Team Lead persona will be responsible for the following tasks:
...
- Adhering to the code repository standards once the repository is under Agentic control, as informed by the Team Lead persona.
