...
**Date:** 2026-02-23
**Status:** in_progress
**Issue:** https://github.com/convergent-systems-co/dark-forge/issues/126
...
Integrate data governance standards from SET-Apps/dach-canonical-models into the Dark Forge governance framework. Create a data-governance-review panel as a required default, enforce canonical model standards on every PR, and implement a workflow for handling missing canonical models (cross-repo issue creation).
