...
**Date:** 2026-02-27
**Status:** in_progress
**Issue:** https://github.com/convergent-systems-co/dark-forge/issues/468
...
Add a GitHub Actions workflow that publishes the MCP server (`mcp-server/`) to GitHub Packages as both an npm package (`@jm-packages/dark-forge-mcp`) and a Docker image (`ghcr.io`) on release events, with a manual dry-run option.
