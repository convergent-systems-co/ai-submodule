...
**Date:** 2026-02-25
**Status:** in_progress
**Issue:** https://github.com/convergent-systems-co/dark-forge/issues/222
...
Reduce the root-level file count of the Dark Forge repository from 18 non-hidden items to 13 by consolidating scattered scripts, docs, and research artifacts into their natural parent directories. Eliminate two top-level directories (`scripts/`, `docs/`) and one orphaned research file.
