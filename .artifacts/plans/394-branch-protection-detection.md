...
**Date:** 2026-02-26
**Status:** approved
**Issue:** https://github.com/convergent-systems-co/dark-forge/issues/394
...
| `governance/personas/agentic/team-lead.md` | Add awareness of `REQUIRES_PR` for structural commits during Phase 2a (project.yaml updates) |
...
- If `REQUIRES_PR=true`: create branch `chore/update-dark-forge`, commit, push, `gh pr create`, wait for CI, `gh pr merge --squash --delete-branch`
...
### Step 6: Update Team Lead persona
