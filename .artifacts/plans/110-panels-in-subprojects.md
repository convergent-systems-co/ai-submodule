...
**Date:** 2026-02-23
**Status:** completed
**Issue:** https://github.com/convergent-systems-co/dark-forge/issues/110
...
| 2026-02-23 | Only create in submodule context | Prevents accidental creation when running init.sh in the Dark Forge repo itself |
