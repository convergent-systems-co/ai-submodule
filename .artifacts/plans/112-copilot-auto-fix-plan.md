...
**Date:** 2026-02-23
**Status:** in_progress
**Issue:** https://github.com/convergent-systems-co/dark-forge/issues/112
...
1. Write `governance/docs/copilot-auto-fix.md` covering:
   ...
   - Integration with Dark Forge governance workflow
